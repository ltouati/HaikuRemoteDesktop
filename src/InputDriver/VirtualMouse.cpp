...
static input_device_ref sMouseDevice = { (char*)"VirtualMouse", B_POINTING_DEVICE, NULL };
static input_device_ref sKeybdDevice = { (char*)"VirtualKeyboard", B_KEYBOARD_DEVICE, NULL };
static input_device_ref* sDeviceList[3] = { &sMouseDevice, &sKeybdDevice, NULL };

static VirtualMouse* sMouse = NULL;
static VirtualMouse* sKeyboard = NULL;
static int32 sRef = 0;
        ...
        if (bytes == sizeof(packet)) {
            ...
            if (packet.type == PACKET_MOUSE) {
                ...
                if (sKeyboard) {
                    ...
                    syslog(LOG_ERR, "VirtualMouse: sKeyboard is NULL! Event dropped.\n");
                    delete event;
                }
            }
        }
